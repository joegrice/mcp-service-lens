...
Contributions are welcome. Please keep changes focused, add tests for behavior changes, and open an issue for larger design proposals. Add a recognized open-source `LICENSE` file before distributing a fork.
